...
if method == 'bbregister':
    ...
    call = ['bbregister', 
            #'--s', subject_name,   #Está feísimo pero bueno... vamos a hacer una trampilla...
...
atlas_path = '/home/aalarcon/TFG/scripts/aparc+aseg_MNI152_2mm.nii' # Determinar donde guardaré el centiloid
atlas_std = ants.image_read(atlas_path)

# Crear la máscara de las ROIS en la imagen PET en std
